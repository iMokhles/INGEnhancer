...
- (UIImage *)activityImage {
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        NSString *imagePath = @"/Library/Application Support/INGEnhancer/INGEnhancer.bundle/ARSpeechActivity-iPad.png";
        return [UIImage imageWithContentsOfFile:imagePath];
    } else {
        NSString *imagePath = @"/Library/Application Support/INGEnhancer/INGEnhancer.bundle/ARSpeechActivity.png";
        return [UIImage imageWithContentsOfFile:imagePath];
    }
}
