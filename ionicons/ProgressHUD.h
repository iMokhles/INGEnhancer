...
#define HUD_IMAGE_SUCCESS		[UIImage imageWithContentsOfFile:@"/Library/Application Support/INGEnhancer/INGEnhancer.bundle/progresshud-success.png"]
#define HUD_IMAGE_ERROR			[UIImage imageWithContentsOfFile:@"/Library/Application Support/INGEnhancer/INGEnhancer.bundle/progresshud-error.png"]
