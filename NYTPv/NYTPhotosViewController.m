...
- (instancetype)initWithPhotos:(NSArray *)photos initialPhoto:(id <NYTPhoto>)initialPhoto {
    ...
    if (self) {
        ...
        _overlayView.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"NYTPhotoViewerCloseButtonX" inBundle:[INGEnhancerHelper ingen_bundle]] landscapeImagePhone:[UIImage imageNamed:@"NYTPhotoViewerCloseButtonXLandscape" inBundle:[INGEnhancerHelper ingen_bundle]] style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonTapped:)];
